...
cell_type <- 'K562'
data.m <- count_marks_cells.l[[cell_type]]
...
# cat('Not centered, not scaled \n')
# prcomp_marks(data.m, cell_type, center = F, scale = F, plot_scree = T)
# 
# cat('Centered, not scaled \n')
# prcomp_marks(data.m, cell_type, center = T, scale = F, plot_scree = T)

cat('Centered and scaled \n')
prcomp_marks(data.m, cell_type, center = T, scale = T, plot_scree = T)
